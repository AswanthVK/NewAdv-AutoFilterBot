...
async def cb_about(bot, update: CallbackQuery):
    ...
    text+=f"""\n<b><i>Bot Support:</i></b> <a href="https://t.me/NewBotzSupport">@NewBotzSupport</a>\n"""
    text+="""\n<b><i>Source Code:</i></b> <a href="https://github.com/AswanthVK/NewAdv-AutoFilterBot">Source</a>"""
